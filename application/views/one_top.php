			...
			<header id="mainHeader" class="navbar-fixed-top" role="banner" style="opacity: 1;transform: scaleY(1);background-color: rgba(255, 255, 255, 0.95);">
						...
						<div class="navbar-header">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse" id="scrollTarget">
								<ul class="nav navbar-nav pull-right">
									<li><a href="/page/P0"><i class="icon-home-outline"></i>扶助簡介</a> </li>
									<li><a href="/page/P1"><i class="icon-star"></i>申請流程</a> </li>
									<li><a href="/page/P2"><i class="icon-popup-1"></i>參考資訊</a> </li>
				...
				<style type="text/css">
					...
					.navbar-default .navbar-nav > .active > a, .navbar-default .navbar-nav>li>a:hover, .navbar-default .navbar-nav>li>a:focus, .navbar-default .navbar-nav > .active > a:hover, .navbar-default .navbar-nav > .active > a:focus {
    					background: rgba(52, 125, 109, 0.66);
    					color: #fff;
					}
				</style>