...
<div id="P1-1Modal" class="modal Modal-info-blue fade" role="dialog" style="/*align-items: center; display: flex;*/">
  <div class="modal-dialog modal-lg">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">應備文件</h4>
      </div>
                        ...
                        <div class="color1 ctaBox ">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <P>可至戶政事務所申請，用以查驗全戶成員身分。(可委由役男戶籍地區公所查調)</P>
                        ...
                        <div class="color1 ctaBox ">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <P>可至國稅局/地方稅務局，用以查驗不動產與動產是否符合限額。(可委由役男戶籍地區公所查調)</P>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="color1 ctaBox ">
                            <div class="row">
	                            <div class="col-sm-2">
	                            	<i class="icon-download-outline iconBig"></i>
	                            </div>
                                <div class="col-sm-10">
                                    <h1>
                                        <strong>全戶所得清單</strong>
                                    </h1>
                                    <P>可至國稅局/地方稅務局/戶政事務所申請，用以查驗全戶所得是否符合限額以及列級等級。(可委由役男戶籍地區公所查調)</P>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="color1 ctaBox ">
                            <div class="row">
	                            <div class="col-sm-2">
	                            	<i class="icon-vcard iconBig"></i>
	                            </div>
                                <div class="col-sm-10">
                                    <h1>
                                        <strong>學生證/在學證明</strong>
                                    </h1>
                                    <P>學生身份的證明文件。</P>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="color1 ctaBox ">
                            <div class="row">
	                            <div class="col-sm-2">
	                            	<i class="icon-warning-empty iconBig"></i>
	                            </div>
                                <div class="col-sm-10">
                                    <h1>
                                        <strong>診斷證明/身心障礙證明/重大傷病證明</strong>
                                    </h1>
                                    <P>身心障礙者，指符合中央衛生主管機關所定之身心障礙等級規定，並持有證明文件；罹患嚴重傷、病及懷孕婦女，應檢具公立醫療機構或私立醫院之診斷書。</P>
...
<div id="P1-2Modal" class="modal Modal-info-blue fade" role="dialog" style="/*align-items: center; display: flex;*/">
  <div class="modal-dialog modal-lg">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">臺中各地區公所</h4>
      </div>
      <div class="modal-body">
      	<div class="row office_list2 col-sm-12">
      		<div class="form-group Ani-FadaIn" style="animation-delay: .1s;">
			<div class="BG"></div>
			<label for="area_S">請選擇欲查詢之區公所</label>
			<!--<input type="number" class="form-control" name="home_members" id="home_members" placeholder="輸入人數"  title="請輸入您的家庭成員數"/>-->
			<select name="area_S" class="form-control required digits" type="number" id="area_S" size="1" value="" placeholder="請選擇區公所" title="請選擇區公所">
				<option>中區區公所</option>
	            <option>東區區公所</option>
	            <option>西區區公所</option>
	            <option>南區區公所</option>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="color4 ctaBox-2 col-md-12" id="office_locate" style="border-radius: 4px; background-color: rgba(255, 255, 255, 0.2);">
                    <div class="row mb15">
                        
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <iframe  width="100%" height="400" frameborder="0" allowfullscreen="" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1051.6014266516638!2d120.67950230379242!3d24.143733596833172!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x4f731237deaa9639!2z5Lit5Y2A5Y2A5YWs5omA!5e0!3m2!1szh-TW!2stw!4v1446131455639"></iframe><br>
                            <br>
                            <h2 style="display: inline-block;"><strong><a href="http://www.central.taichung.gov.tw/" target="_blank">中區公所官方網站</a></strong></h2><div style="display: inline-block;">(可點擊前往)</div><br>
                            <h2 style="display: inline-block;"><strong><a href="tel:+886422222502">04-2222-2502</a></strong></h2><div style="display: inline-block;">(可點擊通話)</div><br>
...
<div id="P1-3Modal" class="modal Modal-info-blue fade" role="dialog" style="/*align-items: center; display: flex;*/">
  <div class="modal-dialog modal-lg">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">役男家屬生活扶助作業流程圖</h4>
      </div>
      <div class="modal-body">

        <div class="">

            <div class="row color4" id="process-fig-row" style="background-color: initial;">
...
MAP_A["新社區公所"]=["http://www.xinshe.taichung.gov.tw/",   "tel:+886425811111",    "04-25811111",      "426 臺中市新社區復盛里興社街二段28之1號","https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3638.2234626830236!2d120.80722731433782!3d24.23396187604949!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x34691c092c3539b9%3A0x55a93500846037d7!2z5paw56S-5Y2A5YWs5omA!5e0!3m2!1szh-TW!2stw!4v1446135513377"];
    ...
    $(".office_list2").on('change','select', function(event) {
        ...
        console.log(M_index);
          ...
          $("#office_locate h2").eq(0).find('a').attr('href', MAP_A[M_index][0]);
          $("#office_locate h2").eq(0).find('a').text(M_index+"官方網站");
          $("#office_locate h2").eq(1).find('a').attr('href', MAP_A[M_index][1]);
          $("#office_locate h2").eq(1).find('a').text(MAP_A[M_index][2]);
          $("#office_locate h2").eq(2).find('strong').text(MAP_A[M_index][3]);
    });
